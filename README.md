...
#### Mosaic (-mosaic dist)
Делит изображение на пиксели размера dist и затем выделяет границы каждого квадрата случайным цветом из изображения. Полученный эффект очень напоминает плитки мозаики.
